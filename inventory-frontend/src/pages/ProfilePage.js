        ...
        {isEditing ? (
          ...
          <div style={styles.infoContainer}>
            <div style={styles.infoRow}>
              <img src="http://134.209.236.158:8369/profus.png" alt="User Icon" style={styles.icon} />
              <span>{profile.username}</span>
            </div>
            <div style={styles.infoRow}>
              <img src="http://134.209.236.158:8369/emfus.png" alt="Email Icon" style={styles.icon} />
              <span>{profile.email}</span>
            </div>
            <div style={styles.infoRow}>
              <img src="http://134.209.236.158:8369/phonfus.png" alt="Phone Icon" style={styles.icon} />
              <span>{profile.phone_number}</span>
            </div>
            <div style={styles.infoRow}>
              <img src="http://134.209.236.158:8369/adfus.png" alt="Address Icon" style={styles.icon} />
...
const styles = {
  ...
  editButton: { backgroundColor: '#8A5C34', color: '#FFFFFF', padding: '10px', borderRadius: '5px', width: '100%', marginTop: '10px' },
  logoutButton: { backgroundColor: '#8A5C34', color: '#FFFFFF', padding: '10px', borderRadius: '5px', width: '100%', marginTop: '10px' },
